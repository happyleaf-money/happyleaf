Contributing to HappyLeaf Coin
============================

The HappyLeaf Core project operates an open contributor model where anyone is
...
The following applies to code changes to The HappyLeaf Core project, and is not to be
confused with overall HLF Network Protocol consensus changes.

Whether a pull request is merged into HappyLeaf Coin rests with the project merge
...
Patches that change HLF consensus rules are considerably more involved than
...
Where a patch set proposes to change the HLF consensus, it must have been
...
The project leader is the release manager for each HappyLeaf Coin release.
