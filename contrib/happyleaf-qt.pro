...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/happyleaf-cli.cpp \
           src/happyleaf-tx.cpp \
           src/happyleaf.cpp \
           src/db.cpp \
           ...
           src/qt/happyleaf.cpp \
           src/qt/happyleafstrings.cpp \
...
RESOURCES += src/qt/happyleaf.qrc src/qt/happyleaf_locale.qrc

TRANSLATIONS += src/qt/locale/happyleaf_bg.ts \
                src/qt/locale/happyleaf_de.ts \
                src/qt/locale/happyleaf_en.ts \
                src/qt/locale/happyleaf_es.ts \
                src/qt/locale/happyleaf_fi.ts \
                src/qt/locale/happyleaf_fr.ts \
                src/qt/locale/happyleaf_it.ts \
                src/qt/locale/happyleaf_ja.ts \
                src/qt/locale/happyleaf_pl.ts \
                src/qt/locale/happyleaf_pt.ts \
                src/qt/locale/happyleaf_ru.ts \
                src/qt/locale/happyleaf_sk.ts \
                src/qt/locale/happyleaf_sv.ts \
                src/qt/locale/happyleaf_vi.ts \
                src/qt/locale/happyleaf_zh_CN.ts \
                src/qt/locale/happyleaf_zh_TW.ts
