...
In order to support loading of multiple wallets in happyleaf-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is happyleaf.cpp.
...
Changes to happyleaf.cpp
----------------------
happyleaf.cpp is the entry point into happyleaf-qt, and as such, will require some minor modifications to provide hooks for
