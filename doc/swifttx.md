...
This mechanism has been integrated into Bitcore-Node-HLF which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/HLF-Project/insight-api-happyleaf#web-socket-api](https://github.com/HLF-Project/insight-api-happyleaf#web-socket-api) 
* API: [https://github.com/HLF-Project/insight-api-happyleaf#swifttx-transactions](https://github.com/HLF-Project/insight-api-happyleaf#swifttx-transactions) 
...
By default, The HappyLeaf Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to The HappyLeaf Core daemon:
