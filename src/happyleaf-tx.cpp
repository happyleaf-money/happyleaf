...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HappyLeaf Core happyleaf-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  happyleaf-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded happyleaf transaction") + "\n" +
                               "  happyleaf-tx [options] -create [commands]   " + _("Create hex-encoded happyleaf transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded happyleaf transaction
