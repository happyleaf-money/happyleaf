...
// Copyright (c) 2017-2020 The HappyLeaf developers
...
#if defined(NDEBUG)
#error "HLF cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uhappyleaf) are considered zero fee (for relaying and mining)
...
{
    RenameThread("happyleaf-scriptch");
