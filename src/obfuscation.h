...
{
public:
    /// Is the inputs associated with this public key? (and there is 2500 HLF - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of happyleaf.
