...
/* HappyLeaf GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "HLF"
#define QAPP_ORG_DOMAIN "happyleaf.icu"
#define QAPP_APP_NAME_DEFAULT "HLF-Qt"
#define QAPP_APP_NAME_TESTNET "HLF-Qt-testnet"
