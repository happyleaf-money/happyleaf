...
/** Utility functions used by the HLF Qt UI.
 */
namespace GUIUtil
{
...
// Render HLF addresses in monospace font
...
// Parse "happyleaf:" URI into recipient object, return true on successful parsing
