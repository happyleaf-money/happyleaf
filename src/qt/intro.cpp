...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HappyLeaf Coin"),
     ...
     * override -datadir in the happyleaf.conf file in the default data directory
     * (to be consistent with happyleafd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
