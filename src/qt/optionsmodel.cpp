...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::THEHLF);
    ...
    if (!settings.contains("nAnonymizeHappyLeafAmount"))
        settings.setValue("nAnonymizeHappyLeafAmount", 1000);

    nAnonymizeHappyLeafAmount = settings.value("nAnonymizeHappyLeafAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeHappyLeafAmount"))
        SoftSetArg("-anonymizehappyleafamount", settings.value("nAnonymizeHappyLeafAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in happyleaf.cpp during shotdown to also remove the window positions
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeHappyLeafAmount:
            return QVariant(nAnonymizeHappyLeafAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case HideOrphans:
            ...
            break;
        case AnonymizeHappyLeafAmount:
            nAnonymizeHappyLeafAmount = value.toInt();
            settings.setValue("nAnonymizeHappyLeafAmount", nAnonymizeHappyLeafAmount);
            emit anonymizeHappyLeafAmountChanged(nAnonymizeHappyLeafAmount);
            break;
        case CoinControlFeatures:
