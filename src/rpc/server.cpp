...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop HappyLeaf server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "HappyLeaf server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HLF features */
        {"happyleaf", "masternode", &masternode, true, true, false},
        {"happyleaf", "listmasternodes", &listmasternodes, true, true, false},
        {"happyleaf", "getmasternodecount", &getmasternodecount, true, true, false},
        {"happyleaf", "masternodeconnect", &masternodeconnect, true, true, false},
//        {"happyleaf", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
//        {"happyleaf", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
//        {"happyleaf", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"happyleaf", "masternodecurrent", &masternodecurrent, true, true, false},
        {"happyleaf", "masternodedebug", &masternodedebug, true, true, false},
        {"happyleaf", "startmasternode", &startmasternode, true, true, false},
        {"happyleaf", "createmasternodekey", &createmasternodekey, true, true, false},
        {"happyleaf", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"happyleaf", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"happyleaf", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"happyleaf", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"happyleaf", "getmasternodescores", &getmasternodescores, true, true, false},
        {"happyleaf", "mnsync", &mnsync, true, true, false},
        {"happyleaf", "spork", &spork, true, true, false},
        {"happyleaf", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> happyleaf-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:25092/\n";
}
