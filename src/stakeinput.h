...
#ifndef HLF_STAKEINPUT_H
#define HLF_STAKEINPUT_H
...
class CHappyLeafStake : public CStakeInput
{
private:
    CTransaction txFrom;
...
public:
    ...
    bool IsZHLF() override { return false; }
    uint256 GetSerialHash() const override { return uint256(0); }
};


#endif //HLF_STAKEINPUT_H
